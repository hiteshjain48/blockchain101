...
def mine_block():
    ...
    blockchain.add_transaction(node_address, 'Hitesh', 1)
...
def connect_node():
    ...
    response = {'message' : "All the nodes are now connected. The Hitcoin Blockchaiin now contains the following nodes",
